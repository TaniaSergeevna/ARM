...
# #
# #     return render(request, 'MenuARM/menu.html', {"people": people, "people1": people1, "people2": people2, "people3": people3,
...
# #     return render(request, 'EmployeeAPM/employee.html')
# #
# #
# # def addDB(request):
# #     people = Menu1.objects.all()
# #     return render(request, 'MenuARM/addDB.html', {"people": people})
# #
# #
# # def db(request):
# #
...
# #             return HttpResponseRedirect("/menu/addDB/")
# #         else:
# #             return render(request, "MenuARM/edit.html", {"person": person})
# #     except Menu1.DoesNotExist:
